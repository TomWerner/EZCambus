...
import com.wernerapps.ezbongo.ui.StopInfoWindowAdapter;
...
public class GoogleMapManager
{
    ...
    public void setMap(Context context, GoogleMap map, SupportMapFragment parent)
    {
        resetBounds();
        this.googleMap = map;
        googleMap.setInfoWindowAdapter(new StopInfoWindowAdapter(context, markerStopMap, parent));
    ...
    {
        MarkerOptions mark = new MarkerOptions();
        mark.title("" + stop.getStopNumber() + " " + stop.getStopTitle());
        ...
        maxLongitude = Math.max(minLongitude, stop.getPosition().longitude);
    }
